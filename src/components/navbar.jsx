...
export default function Navbar() {
    const [url, setUrl] = useState('/Todo-Timer')
    ...
    return (
        <div className="btm-nav z-40 ">
            <Link to="/timer" className= {url=="/timer"?'active':'w-full'} onClick={()=>{setUrl('/timer');}}>
            ...
            <Link to="/todo" className={url=="/todo"||url=="/"?'active':"w-full"} onClick={()=>{setUrl('/todo');}}>
                <button className="flex  flex-col justify-center items-center" >
